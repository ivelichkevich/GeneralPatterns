...
import static com.aurea.testgenerator.generation.patterns.nullchecking.NullCheckingTestTypes.NULL_CHECING
...
@Log4j2
class NullCheckingTestGenerator implements TestGenerator {
